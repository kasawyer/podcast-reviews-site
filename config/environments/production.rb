Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "podcast-reviews-site_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'https://arcane-bastion-60789.herokuapp.com', port: 587 }
end
